...
( ( tinymce ) => {
	tinymce.create(
		'tinymce.plugins.fau_degree_program_output_shortcodes_plugin',
		{
	...
	tinymce.PluginManager.add(
		...
		tinymce.plugins[ 'fau_degree_program_output_shortcodes_plugin' ] // eslint-disable-line dot-notation
	);
} )( window.tinymce );
