...
type Selectors = {
    ...
    getDegreePrograms(state: State, queryArgs: QueryArgs): Array<DegreeProgram> | null | undefined;
    hasDegreePrograms(state: State, queryArgs: QueryArgs): boolean;
};

type Actions = {
    receiveDegreeProgram(degreeProgram: DegreeProgram): object;
    receiveDegreePrograms(query: Query, degreePrograms: Array<DegreeProgram>): object;
};

export type DegreeProgramStore = StoreDescriptor<ReduxStoreConfig<State, Actions, Selectors>>;
